...
.addBtn:hover {
  background-color: #bbb;
	...
	<?php
				...
				$sql = "SELECT guest_res.date_in, guest_res.date_out, guest_res.num_of_people, guest_res.price_gr, rooms.num, guests_info.egn , guests_info.first_nm, guests_info.last_nm, guests_info.gsm FROM guest_res JOIN guests_info ON guest_res.gid  = guests_info.id JOIN rooms ON guest_res.room_num  = rooms.id WHERE guests_info.hotel_gid  = '".$hid."' AND   guest_res.date_out BETWEEN CURDATE() AND CURDATE()+INTERVAL 3 DAY; "; //get data for 3 days ahead
...
<body style="background-image: url('../../img/background.jpg'">
	...
	<div style="padding-left: 5%; padding-top: 3%; padding-bottom: 3%; padding-right: 5%; position: relative;">
		...
		<div id="myDIV" class="header">
		  <h2>Lightgreen Reservations End Today</h2>		 
